    ...
    public class PokemonNegocio
    {
        ...
        public void modificar(Pokemon poke)
        {
          AccesoDatos datos = new AccesoDatos();
            try
            {
                datos.setearConsulta("update POKEMONS set Numero = @num, Nombre = @nombre, Descripcion = @desc, UrlImagen = @img, IdTipo = @IdTipo, IdDebilidad = @IdDebilidad where Id = @id");
                datos.setearParametro("@num", poke.Numero);
